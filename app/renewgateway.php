...
if($numrows==1) {
	...
	<input type="hidden" name="notify_url" value="http://www.Referro.in/demo/cdecnyn/user/success.php?method=PAYPAL"> 
...
if($numrows==1) {
    ...
    <input type="hidden" name="ap_alerturl" value="http://www.Referro.in/demo/cdecnyn/user/success.php?method=PAYZA">
...
<form action="https://solidtrustpay.com/handle.php" method="post">
    ...
    <input type="hidden" name="amount" value="<?php print $total ?>">
    <input type="hidden" name="notify_url" value="http://www.Referro.in/demo/cdecnyn/user/success.php?method=SOLIDTRUSTPAY">
