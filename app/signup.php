...
$msg="";
//validation starts
// if userid is less than 1 char then status is not ok
if(!isset($username) or strlen($username) <1){
$msg=$msg."User Id Should Contain Minimum 1 CHARACTERS.<BR>";
$status= "NOTOK";}	
...
$msg=$msg."Password Must Be More Than 4 Char Length.<BR>";
$status= "NOTOK";}	
...
if ($status=="OK") 
{	
$scode=rand(22,12); //generating random code, this will act as signup key
...
<?php 
			...
			echo $_SESSION['aff']; } ?>" required>                        
						...
						<!--The Bank Teller Code -->
			<div class="form-group">
                          <label>Bank Deposit Slip/Teller Code</label>
                          <input type="text" class="form-control" data-required="true" name="teller" value="" required>                        
                        </div>
						
						<div class="g-recaptcha" data-sitekey="6LcZziATAAAAAGdUGqk4UjTrx0UPHmWrdq-XpF8T"></div>
          ...
          <p class="text-muted text-center"><small style="color:#1AAE88;"><strong>Already have an account?</strong></small></p>
...
<footer id="footer">
  <div class="text-center padder clearfix">
    <p> <small style="color:#ccc;"><?php $query="SELECT footer from settings where sno=0"; 
